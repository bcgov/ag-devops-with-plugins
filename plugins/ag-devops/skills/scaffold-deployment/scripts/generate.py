#!/usr/bin/env python3
"""
Generate an ag-helm-templates Deployment Helm template file.

Writes to <output-dir>/<name>-deployment.yaml using the "set + define + include"
...
def main():
    parser = argparse.ArgumentParser(
        description="Generate ag-helm-templates Deployment Helm template"
    )
    ...
    out_path = os.path.join(args.output_dir, f"{args.name}-deployment.yaml")
